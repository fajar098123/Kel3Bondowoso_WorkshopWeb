...
<div class="text-center ">
    ...
    <div class="view_wrap list-view">
        <div class="view_item">
            <div class="vi_left">
                <img src="img/tumbuhan-kopi1.jpg" class="card-img-top" alt="...">
                </div>
                <div class="vi_right">
        ...
        <div class="view_item">
            <div class="vi_left">
            <img src="img/tumbuhan-kopi2.jpg" class="card-img-top" alt="...">
                </div>
                <div class="vi_right">
                    <h5 class="title">Faktor yang mempengaruhi tumbuhan kopi</h5>
                    </br>
        ...
        <div class="view_item">
            <div class="vi_left">
            <img src="img/tumbuhan-kopi3.jpg" class="card-img-top" alt="...">
                </div>
                <div class="vi_right">
                    <h5 class="title">Faktor yang mempengaruhi tumbuhan kopi</h5>
                    </br>
