              ...
              <div class="card-body">
                <form action="">
                  ...
                  <label for="form-gruop">Agama</label>
                    <select class="form-control" id="form-gruop" name="selectagama">
                      <option>Islam</option>
                  ...
                  <div>
                    <textarea name="biografi" class="form-control" id="name" rows="3" placeborder="Biografi"></textarea>
                  </div>
                  <br>
                  ...
                  if($biografi){
                    echo "<strong>Biografi: </strong> {$biografi}";
                  }
                  ?>
                </form>
              </div>
