            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form method="post" action = "login_action.php" class="user">
                    <div class="form-group">
                      <input type="text" name="user" class="form-control form-control-user" id="exampleInputUsername" aria-describedby="UsernameHelp" placeholder="Username">
                    </div>
                    <div class="form-group">
