            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <label for="form-group">Agama</label>
                    <select class="form-control" id="form-group" name="agama">
                        <option>Islam</option>
                  ...
                  <div class="form-group">
                    <textarea class="form-control" id="name" rows="3" name="text"></textarea>
                  </div>
                  ...
                  if($text){
                    echo "<strong>Biografi: </strong> {$text} <br>";
                  }
                  ?>
                </form>
              </div>
