            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <input type="radio" name="Gender" id="name" value="Laki-laki">
                    <label for="name">Laki-laki</label>
                    <input type="radio" name="Gender" id="name" value="Perempuan">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea name="biografi" id="controlTextArea" rows="3" class="form-control"></textarea>
                    </div>
